...
export const Hero = () => {
  return (
    <section
      className="h-[492px] flex items-center justify-center relative overflow-hidden"
    ...
    >
      ...
      <div className="absolute h-[344px] w-[344px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
      ...
      <div className="absolute h-[544px] w-[544px] rounded-full border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 left-0 bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute h-2 w-2 left-1/2 bg-white rounded-full top-0 -translate-x-1/2 -translate-y-1/2"></div>
      </div>
