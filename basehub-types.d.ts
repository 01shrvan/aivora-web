...
export interface Scalars {
  ...
  type: "file"
    ...
    BSHBSelect__552439612: 'draft' | 'published',
    Boolean: boolean,
...
export type BlockDocument = (Blog | BlogComponent | Projects | ProjectsComponent | _AgentStart | blogComponent_AsList | projectsComponent_AsList) & { __isUnion?: true }
...
export type BlockList = (Blog | Projects | blogComponent_AsList | projectsComponent_AsList) & { __isUnion?: true }
...
/** Rich text block */
export type BlockRichText = (Content | Tags) & { __isUnion?: true }
...
export interface BlogComponent {
    ...
    _title: Scalars['String']
    content: Content
    status: Scalars['BSHBSelect__552439612']
    thumbnail: MediaBlockUnion
...
export interface Projects {
    ...
    _title: Scalars['String']
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item: (ProjectsComponent | null)
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items: ProjectsComponent[]
    __typename: 'Projects'
}
...
export interface ProjectsComponent {
    ...
    tags: Tags
    __typename: 'ProjectsComponent'
}

export type ProjectsComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'description__ASC' | 'description__DESC' | 'links__ASC' | 'links__DESC' | 'tags__ASC' | 'tags__DESC'
...
export type RichTextJson = (BaseRichTextJson | ContentRichText | TagsRichText) & { __isUnion?: true }
...
export interface TagsRichText {
    content: Scalars['BSHBRichTextContentSchema']
    toc: Scalars['BSHBRichTextTOCSchema']
    __typename: 'TagsRichText'
}
...
export interface _components {
    ...
    projects: projectsComponent_AsList
...
export interface projectsComponent_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
    ...
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items: ProjectsComponent[]
    __typename: 'projectsComponent_AsList'
}
...
export interface BlockDocumentGenqlSelection{
    ...
    on_ProjectsComponent?: ProjectsComponentGenqlSelection
    on__AgentStart?: _AgentStartGenqlSelection
    on_blogComponent_AsList?: blogComponent_AsListGenqlSelection
    on_projectsComponent_AsList?: projectsComponent_AsListGenqlSelection
    __typename?: boolean | number
...
export interface BlogComponentGenqlSelection{
    ...
    thumbnail?: MediaBlockUnionGenqlSelection
    __typename?: boolean | number
...
export interface ProjectsGenqlSelection{
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: ProjectsComponentGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: ProjectsComponentGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "Projects"
}

export interface ProjectsComponentGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    __typename?: boolean | number
    __fragmentOn?: "ProjectsComponent"
}

export interface ProjectsComponentFilterInput {AND?: (ProjectsComponentFilterInput | null),OR?: (ProjectsComponentFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),description?: (StringFilter | null),links?: (StringFilter | null)}

export interface ProjectsComponentSearchInput {
/** Searchable fields for query */
by?: (Scalars['String'][] | null),
/** Search query */
q?: (Scalars['String'] | null)}
...
export interface QueryGenqlSelection{
    ...
    /** Filter by a field. */
    filter?: (ProjectsComponentFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (ProjectsComponentOrderByEnum | null), 
    /** Search configuration */
    search?: (ProjectsComponentSearchInput | null), 
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    __typename?: boolean | number
    __fragmentOn?: "Query"
...
export interface RichTextJsonGenqlSelection{
    ...
    on_TagsRichText?: TagsRichTextGenqlSelection
    __typename?: boolean | number
...
export interface TagsGenqlSelection{
    ...
    /** Inserts a table of contents at the beginning of the HTML. */
    toc?: (Scalars['Boolean'] | null)} } | boolean | number
    json?: TagsRichTextGenqlSelection
    markdown?: boolean | number
    plainText?: boolean | number
    readingTime?: { __args: {
    /** Words per minute, defaults to average 183wpm */
...
export interface TagsRichTextGenqlSelection{
    content?: boolean | number
    toc?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "TagsRichText"
}
...
export interface _componentsGenqlSelection{
    ...
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    projects?: (projectsComponent_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (ProjectsComponentFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
...
export interface projectsComponent_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    items?: ProjectsComponentGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "projectsComponent_AsList"
}
...
export interface FragmentsMap {
  ...
  ProjectsComponent: {
    root: ProjectsComponent,
    selection: ProjectsComponentGenqlSelection,
}
  Query: {
    root: Query,
  ...
  TagsRichText: {
    root: TagsRichText,
    selection: TagsRichTextGenqlSelection,
}
  TransactionStatus: {
  ...
  projectsComponent_AsList: {
    root: projectsComponent_AsList,
    selection: projectsComponent_AsListGenqlSelection,
}
}
